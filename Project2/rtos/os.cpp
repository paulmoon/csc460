...
// array of MAXPROCESS quees
// each entry in the array corresponds to a service
// array of service structs
struct service {
    // is there a need to associate the service to the task    
}
...
#define    SAVE_CTX_TOP()       asm volatile (\
    ...
    "in     r31,0X3C        \n\t"\
    "push   r31             \n\t"\
    "in     r31,__SREG__    \n\t"\    /* save the status register into r31 */
    "cli                    \n\t"::); /* Disable interrupt */
